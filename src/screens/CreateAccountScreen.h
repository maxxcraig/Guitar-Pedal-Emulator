...
{
public:
    CreateAccountScreen(std::function<void()> goToHomeScreen)
    {
        background = juce::ImageCache::getFromFile(juce::File::getCurrentWorkingDirectory().getChildFile("resources/login-background.png"));
        ...
        signUpButton.onClick = goToHomeScreen;
    ...
    void resized() override
    {
        ...
        signUpButton.setBounds(passwordEditor.getX(), passwordEditor.getBottom() + spacing, fieldWidth, 40);
    }
